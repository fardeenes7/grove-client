  ...
  const Form = () => {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        const response = await axios.post("/api/book-event", {
          ...formData,
        ...
        <div className="container mx-auto px-4 md:px-[20%] py-10">
          <div className="flex flex-col items-center justify-center mt-40 gap-2 text-white">
            ...
            <p className="text-lg font-normal text-justify mt-2">
              Looking to host a private event? The Grove offers a versatile
              space for various occasions from birthday parties to corporate
              events, team building exercises and private clinics.
            </p>
            ...
            <p className="text-lg font-normal text-left mb-4">
              Contact us to explore the possibilities and see if The Grove is
            ...
            <p className="text-base font-light text-justify my-4">
              ...
              details about your requirements. We will review your request
              within 48 hours. A member of our team will reach out to you via
              email or phone to discuss your event. Thank you for considering
              us!
            </p>
            <Form />
          </div>
