...
const SubscribeCTA = () => {
  ...
  return (
    <div className="container mx-auto">
      <div className="flex flex-col md:flex-row items-center justify-around px-6 py-4 lg:py-16 mx-10 lg:mx-32">
        <div className="flex flex-col items-center md:flex-row text-white mb-4 md:mb-0">
          ...
          <div className="ml-5 flex flex-col">
            ...
            <p className="font-bold text-xl md:text-4xl italic tracking-widest">
