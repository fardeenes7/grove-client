      ...
      <div className="bg-primary">
        ...
        <div className="bg-white">
          <div className="container mx-auto max-w-[1280px]">
            <div className="relative flex flex-col md:flex-row items-center md:p-6 py-16 md:py-32 md:gap-24">
              {/*Background_Image*/}
              <div className="absolute inset-0 bg-[url('/Vector.svg')] bg-center bg-fixed bg-auto bg-no-repeat z-0"></div>
              {/* Logo */}
              <div className="w-[20rem] md:w-[30rem] relative z-10 mb-4 md:mb-0">
                <Image
                  src={WelcomeImg}
                  alt="welcome-grove"
                  className="w-full"
              ...
              <div className="relative md:w-[58%] z-10 bg-opacity-75 white-space-pre-line mb-5 md:mb-0 mx-4 ms:mx-0">
                ...
                <p className="mt-2 text-sm lg:text-xl font-semibold mb-3 text-center md:text-start text-[#0E0E0E]">
                ...
                <p className="mt-2 text-sm lg:text-xl font-semibold mb-3 text-[#0E0E0E] text-center md:text-start">
                ...
                <p className="mt-2 text-sm md:text-xl font-semibold text-secondary text-center md:text-start">
