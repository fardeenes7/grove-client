    ...
    return (
        <div className="bg-[#FFFF] pt-16 lg:pt-36 pb-20">
            <div className="container max-w-[1120px mx-auto">
                ...
                <p className="md:w-2/4 text-center mx-auto md:text-xl 3xl:text-2xl">
                    Like a guiding star, your sponsorship lights our path to
                    success. Together, let’s make dreams reality and build a
                    future filled with achievements..
                </p>
                <div>
                    <div className="flex justify-center flex-wrap gap-8 py-16">
                        <Image
                            src={Logo1}
                            alt="serlkirk"
                            className="w-[80%] sm:w-[40%] md:w-[20rem]"
                        />
                    </div>
                </div>
            </div>
